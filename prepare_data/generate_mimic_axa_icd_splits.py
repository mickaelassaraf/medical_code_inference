...
from src.settings import (
    DATA_DIRECTORY_MIMIC_AXA_ICD10,
    ID_COLUMN,
    SUBJECT_ID_COLUMN,
    TARGET_COLUMN,
)
...
output_dir_icd10 = Path(DATA_DIRECTORY_MIMIC_AXA_ICD10)

axa_icd10 = pd.read_feather(output_dir_icd10 / "mimic_axa_icd10.feather")
...
generate_split(axa_icd10, output_dir_icd10 / "mimic_axa_icd10_split.feather")
