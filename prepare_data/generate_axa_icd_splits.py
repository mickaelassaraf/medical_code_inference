...
import pandas as pd
from src.settings import (DATA_DIRECTORY_AXA_ICD10, ID_COLUMN,
...
output_dir_icd10 = Path(DATA_DIRECTORY_AXA_ICD10)

axa_icd10 = pd.read_feather(output_dir_icd10 / "axa_icd10.feather")
axa_icd10[TARGET_COLUMN] = axa_icd10[TARGET_COLUMN].apply(lambda x: list(x))
...
generate_split(axa_icd10, output_dir_icd10 / "axa_icd10_split.feather")
